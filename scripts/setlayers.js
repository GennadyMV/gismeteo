...
function SetLayers() {
    ...
    //new modis
    var new_modis = new dcrscplaneta.WMSLayer({ url: ip_serv + "geoserver/dvrcpod/wms", after180: true, layer: "dvrcpod:mega", id: "mega", visible: true }); cntLayers++;
    ...
    if (token != "") {
        ...
        map.addLayers([ modis, meteor, landsat, resurs, kanopus,
                        ...
                        lBorders, lRestrict, lCity, lRivers, lRoads, lShoreline, new_modis]);
    } else {
        map.addLayers([ modis, meteor, landsat, resurs, kanopus,
                        floods, snow_map, snow_line, clouds, cloudsAfter180, Ascat,
                        borsh, borsh2,
