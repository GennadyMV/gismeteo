...
//по таблице с уровнями для предсказаний
var predictProcessing = false; //идет обсчет разлива
var predictPreEditData = "";   //глобальная переменная где хранится строка с предредактируемым состоянием
var predictIsEdit = false;     //если труэ значит сейчас открыто поле для редаткирования какоголибо уровня
//var geoprocessorPredict;       //геопроцессор на предсказалки
...
var lDConfig = {
    ...
    'GRIB_HGT_FIELD'    : { visName: "Геопотенциал (заливка)", chBoxes: ['cbHGTField'], dField: 'datadatetime', fLegend: "" },
    'GRIB_TMP_FIELD'    : { visName: "Температура (заливка)", chBoxes: ['cbTMPField'], dField: 'datadatetime', fLegend: "" },
    'GRIB_RH_FIELD'     : { visName: "Влажность (заливка)", chBoxes: ['cbRHField'], dField: 'DataDateTime', fLegend: "" },
    'GRIB_PRMSL_FIELD'  : { visName: "Давление (заливка)", chBoxes: ['cbPRMSLField'], dField: 'DataDateTime', fLegend: "" },
    ...
    'GRIB_TCDC_FIELD': { visName: "Облачность", chBoxes: ['cbTCDCField'], dField: 'datadatetime', fLegend: '<div style="position:relative; height:75px;"><div style="text-align:center;">баллы</div><table style="table-layout: fixed; margin-left:10px;" cellspacing="0" border="1" height="25"><col style="width: 22px;"/><col style="width: 22px;"/><col style="width: 22px;"/><col style="width: 22px;"/><col style="width: 22px;"/><col style="width: 22px;"/><col style="width: 22px;"/><tr><td style="background:rgb(50, 50, 50)"></td><td style="background:rgb(65, 65, 65)"></td><td style="background:rgb(80, 80, 80)"></td><td style="background:rgb(100, 100, 100)"></td><td style="background:rgb(120, 120, 120)"></td><td style="background:rgb(170, 170, 170)"></td><td style="background:rgb(230, 230, 230)"></td></tr></table><div style="position:absolute; left:2px;">3</div><div style="position:absolute; left:24px;">4</div><div style="position:absolute; left:46px;">5</div><div style="position:absolute; left:68px;">6</div><div style="position:absolute; left:90px;">7</div><div style="position:absolute; left:112px;">8</div><div style="position:absolute; left:134px;">9</div><div style="position:absolute; left:160px;">10</div></div>' },
    ...
    "LevelPred": { visName: "Прогноз уровней воды", chBoxes: ["cbLevelForecast"], dField: "datef", fLegend: "", datefromlayer: "0" },
    //Static
    ...
    'PredictFlood'         : { visName: "Расчет разливов", chBoxes: ["cbFloodPred"], dField: "", fLegend: "" }
};
