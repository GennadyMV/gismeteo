...
require([
    ...
    declare("dcrscplaneta.elLegend", [dijit._Widget, dijit._Templated], {
        templateString: "<div class=\"elLegend\"><div><span class=\"arr\" data-dojo-attach-point=\"arLeft\" data-dojo-attach-event=\"onclick:ShowHideSubLegend\"></span><div class=\"legend_element_set\"><span class=\"settings\" style=\"display:none\" data-dojo-attach-point=\"arSet\" data-dojo-attach-event=\"onclick:ShowHideSettings\"></span><span class=\"arrdown\" data-dojo-attach-point=\"arDown\"></span><span class=\"arrup\" data-dojo-attach-point=\"arUp\"></span></div><span data-dojo-attach-point=\"titleNode\" style=\"font-weight:bold;\"></span></div><div class=\"clsPlatform\" data-dojo-attach-point=\"Platform\"></div><div class=\"tree-view\" data-dojo-attach-point=\"Legend\"></div></div>",
